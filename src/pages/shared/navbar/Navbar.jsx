...
const Navbar = () => {
  ...
  <NavLink to='/contact' className={({ isActive }) => isActive ?  "border-b-2 border-red-600" : ""}><li className="text-xl font-poppins text-white ">Contact US</li></NavLink>
   ...
   if(loading){
    return <div className="flex justify-center items-center h-screen"><ScaleLoader
    color="#36a5d6"
    height={100}
    radius={9}
    width={20}
    ...
    return (
      ...
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-[#0284C7] rounded-box w-52">
            {navLink}
          </ul>
        </div>
